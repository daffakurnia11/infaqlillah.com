...
<h6 class="mb-0 text-uppercase d-flex justify-content-between align-items-center">
  ...
  <a href="/admin/modal-toko/create" data-bs-toggle="modal" data-bs-target="#expanseModal" class="btn btn-sm btn-primary addShopExpanse">Tambah Pengeluaran</a>
</h6>
<hr/>
<div class="row">
  <div class="col-xxl-8">
              ...
              <tr>
                ...
                <td class="align-middle text-nowrap">
                  <div class="table-actions d-flex align-items-center justify-content-center gap-3 fs-6">
                    ...
                    <form action="/admin/modal-toko/{{ $data->id }}" method="POST">
                      @csrf
                      @method('DELETE')
...
<div class="modal fade" id="expanseModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="/admin/modal-toko" method="POST" id="form-container" enctype="multipart/form-data">
        @csrf
        @method('POST')

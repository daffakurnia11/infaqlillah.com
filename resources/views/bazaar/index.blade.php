...
<h6 class="mb-0 text-uppercase d-flex justify-content-between align-items-center">
  ...
  <a href="/jumat-berkah/create" data-bs-toggle="modal" data-bs-target="#bazaarModal" class="btn btn-sm btn-primary addBazaar">Tambah Pengeluaran</a>
</h6>
<hr/>
<div class="row">
  <div class="col-xxl-8">
...
<div class="modal fade" id="bazaarModal" tabindex="-1" aria-hidden="true">

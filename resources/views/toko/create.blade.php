...
<div class="row">
  <div class="col-xl-6 mx-auto">
    <h6 class="mb-0 text-uppercase d-flex justify-content-between align-items-center">Form Tambah Pemasukkan</h6>
    <hr/>
    <div class="card">
      <div class="card-body">
        <div class="border p-3 rounded">
          <form action="/admin/toko" method="POST" class="row g-3">
            @csrf
            <div class="col-12">
              <label class="form-label">Nama Pembeli</label>
              <input type="text" class="form-control @error('buyer') is-invalid @enderror" name="buyer" value="{{ old('buyer') }}" tabindex="1" autofocus>
              @error('buyer')
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('notes') is-invalid @enderror" rows="4" cols="4" name="notes" tabindex="3">{{ old('notes') }}</textarea>
              @error('notes')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
            ...
            <div class="col-12">
              <div class="d-grid">
                <button type="submit" class="btn btn-primary" tabindex="4">Tambah Pedagang</button>
              </div>
            </div>
          </form>
        </div>

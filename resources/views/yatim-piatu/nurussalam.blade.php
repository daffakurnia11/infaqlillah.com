...
<h6 class="mb-0 text-uppercase d-flex justify-content-between align-items-center">
  ...
  <a href="/yatim-piatu/create" class="btn btn-sm btn-primary">Tambah Pengeluaran</a>
</h6>
<hr/>
<div class="card">
  <div class="card-body">
            ...
            <tr>
              ...
              <td class="align-middle text-nowrap">
                <div class="table-actions d-flex align-items-center justify-content-center gap-3 fs-6">
                  ...
                  <a href="/yatim-piatu/{{ $data->id }}/edit" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Ubah" aria-label="Ubah"><i class="bi bi-pencil-fill"></i></a>
                  <form action="/yatim-piatu/{{ $data->id }}" method="POST">
                    @csrf
                    @method('DELETE')

...
<h6 class="mb-0 text-uppercase d-flex justify-content-between align-items-center">
  ...
  <a href="/admin/pedagang/create" class="btn btn-sm btn-primary">Tambah Pedagang</a>
</h6>
<hr/>
<div class="card">
  <div class="card-body">
            ...
            <tr>
              ...
              <td class="align-middle text-nowrap">
                <div class="table-actions d-flex align-items-center justify-content-center gap-3 fs-6">
                  <a href="/admin/pedagang/{{ $merchant->number }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Detail" aria-label="Detail"><i class="bi bi-eye-fill"></i></a>
                  <a href="/admin/pedagang/{{ $merchant->number }}/edit" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Ubah" aria-label="Ubah"><i class="bi bi-pencil-fill"></i></a>
